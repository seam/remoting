...
Seam.Context = function() {
    ...
    Seam.Context.prototype.setCallId = function(callId) {
        this.callId = callId;
    };
    Seam.Context.prototype.getCallId = function() {
        return this.callId;
    };
};
...
Seam.validate = function(beansList, callBack, groups) {
    ...
    if (beansList.length > 0) {
        ...
        if (flag) {
            ...
            var processorProcedure = function(doc) {
                Seam.processMetaData(doc);
            };
...
Seam.addSubGroup = function(bean, subGroupName, superGroupName) {
    ...
    if (metadata.__groupHierarchy != undefined) {
        ...
        hierarchyNode.parents = [function() {
        }.id = id];
